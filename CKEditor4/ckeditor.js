...
(function () {
			...
			var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
				d = {
					...
					appendTimestamp: function (a) {
						if (Array.isArray(a) || !this.timestamp || '/' === a.charAt(a.length - 1) || /[&?]t=/.test(a)) return a;
							...
							try {
								document.addEventListener
									...
									: document.attachEvent &&
										...
										(document.detachEvent('onreadystatechange', a), window.detachEvent('onload', a), b());
							} catch (c) {}
						}
						function b() {
			...
			(CKEDITOR.event.prototype = (function () {
				...
				return {
					...
					on: function (b, c, k, h, l) {
						function r(w, y, z, l) {
							w = { name: b, sender: this, editor: w, data: y, listenerData: h, stop: z, cancel: l, removeListener: g };
						...
						if (0 > y.getListenerIndex(c)) {
							...
							for (var z = y.length - 1; 0 <= z; z--)
								if (y[z].priority <= l) return y.splice(z + 1, 0, r), { removeListener: g };
							y.unshift(r);
						}
	...
	(function () {
		function a(a, y, b) {
			...
			this.input = function () {
				...
				if (!c._scheduledTimer || !1 !== c._reschedule()) {
					...
					w < c._minInterval ? (c._scheduledTimer = setTimeout(a, c._minInterval - w)) : a();
				}
			};
		}
		function d(w, y, b) {
		...
		var b = [],
			...
			r = { lt: '\x3c', gt: '\x3e', amp: '\x26', quot: '"', nbsp: ' ', shy: '­' },
			g = function (a, y) {
				return '#' == y[0] ? String.fromCharCode(parseInt(y.slice(1), 10)) : r[y];
			};
		...
		CKEDITOR.tools = {
			...
			extend: function (a) {
				...
				'boolean' == typeof (c = arguments[b - 1])
					? b--
					: 'boolean' == typeof (c = arguments[b - 2]) && ((g = arguments[b - 1]), (b -= 2));
				for (var h = 1; h < b; h++) {
					var m = arguments[h] || {};
			...
			htmlEncode: function (a) {
				return void 0 === a || null === a
					? ''
					: String(a).replace(f, '\x26amp;').replace(e, '\x26gt;').replace(k, '\x26lt;');
			},
			...
			transformPlainTextToHtml: function (a, b) {
				...
				g = g.replace(/\n/g, '\x3cbr\x3e');
				c ||
					(g = g.replace(new RegExp('\x3cbr\x3e(?\x3d\x3c/' + h + '\x3e)'), function (a) {
			...
			getCookie: function (a) {
				...
				for (var b = document.cookie.split(';'), c, g, h = 0; h < b.length; h++)
					if (((c = b[h].split('\x3d')), (g = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase())), g === a))
			...
			escapeCss: function (a) {
				if (a)
					if (window.CSS && CSS.escape) a = CSS.escape(a);
						...
						a = String(a);
						for (var b = a.length, c = -1, g, h = '', m = a.charCodeAt(0); ++c < b; )
							(g = a.charCodeAt(c)),
								(h =
									0 == g
										? h + '�'
			...
			convertBytesToBase64: function (a) {
				...
				for (g = 0; g < c; g += 3) {
					...
					for (d = 0; 4 > d; d++)
						b =
							d <= m ? b + 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(e[d]) : b + '\x3d';
				}
				return b;
			},
			style: {
			...
			array: {
				...
				some: function (a, b, c) {
					for (var g = 0; g < a.length; g++) if (b.call(c, a[g], g, a)) return !0;
					return !1;
				},
				zip: function (a, b) {
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
		...
		getIndex: function (a) {
			...
			do
				if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || (!f && !b.isEmpty()))
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			isEmptyInlineRemoveable: function () {
				...
				for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
					...
					if (g.type != CKEDITOR.NODE_ELEMENT || !g.data('cke-bookmark'))
						if (
							(g.type == CKEDITOR.NODE_ELEMENT && !g.isEmptyInlineRemoveable()) ||
			...
			removeStyle: function (a) {
				...
				if (b.removeProperty || ('border' != a && 'margin' != a && 'padding' != a))
					...
					for (var b = [], d = 0; d < c.length; d++)
						if (g) for (var e = 0; e < g.length; e++) b.push([a, c[d], g[e]].join('-'));
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version : 1)) {
					...
					M &&
						(CKEDITOR.env.webkit || (CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
							? ((b = d.$?.scrollLeft || k?.scrollLeft), (c = d.$?.scrollTop || k?.scrollTop))
							: ((c = e ? d.$ : k), (b = c.scrollLeft), (c = c.scrollTop)),
						(b = f.left + b - m),
						(c = f.top + c - t));
				} else
					for (t = this, m = null; t && 'body' != t.getName() && 'html' != t.getName(); ) {
						b += t.$.offsetLeft - t.$.scrollLeft;
						c += t.$.offsetTop - t.$.scrollTop;
						t.equals(this) || ((b += t.$.clientLeft || 0), (c += t.$.clientTop || 0));
						for (; m && !m.equals(t); ) (b -= m.$.scrollLeft), (c -= m.$.scrollTop), (m = m.getParent());
						m = t;
			...
			scrollIntoParent: function (a, b, c) {
				...
				function t(a, b) {
					...
					g = a.getWindow();
					g.equals(b) || ((g = t(CKEDITOR.dom.element.get(g.$.frameElement), b)), (c.x += g.x), (c.y += g.y));
					return c;
				}
				function m(a, b) {
				...
				for (var g = 0; g < c.length; g++) {
					...
					if (!(e in b))
						if ('checked' == e && (f = this.getAttribute(e))) a.setAttribute(e, f);
							...
							(f = this.getAttribute(e)), null === f && (f = d.nodeValue), a.setAttribute(e, f);
				}
			...
			getEditor: function (a) {
				...
				for (c in b)
					if (
						((g = b[c]),
						(g.element.equals(this) && g.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) ||
							(!a && (d = g.editable()) && (d.equals(this) || d.contains(this))))
					)
						return g;
				return null;
			},
	...
	(function () {
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				...
				this._.guardLTR = function (a, b) {
					return (
						(!b || !l.equals(a)) && (!x || !a.equals(x)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
					);
				};
			}
			if (a && !this._.guardRTL) {
				...
				this._.guardRTL = function (a, b) {
					return (
						(!b || !K.equals(a)) && (!p || !a.equals(p)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
					);
				};
			}
			...
			this.current
				...
				: (a
						? g.type == CKEDITOR.NODE_ELEMENT &&
							(g = 0 < f ? g.getChild(f - 1) : !1 === w(g, !0) ? null : g.getPreviousSourceNode(!0, k, w))
						: ((g = d),
							g.type == CKEDITOR.NODE_ELEMENT &&
								((g = g.getChild(e)) || (g = !1 === w(d, !0) ? null : d.getNextSourceNode(!0, k, w)))),
					g && !1 === w(g) && (g = null));
			for (; g && !this._.end; ) {
				this.current = g;
		...
		var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
			...
			l = function (a) {
				return (
					k(a) || e(a) || (a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty))
				);
			};
		...
		CKEDITOR.dom.walker.empty = function (a) {
			return function (b) {
				for (var c = 0, g = b.getChildCount(); c < g; ++c) if (!r(b.getChild(c))) return !!a;
				return !a;
			};
		};
		var g = CKEDITOR.dom.walker.empty(),
			w = (CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(
				(function (a) {
					var b = {},
						c;
	...
	(function () {
		...
		function d(a, b, c, d, e) {
			function f(a, b, c, g) {
				...
				if (g && k) return L;
				l || g ? b.append(a.clone(!0, e), c) : (a.remove(), r && b.append(a, c));
				return L;
			}
			function m() {
				var a,
				...
				for (a = 0; a < g; a++) if (((b = O[a]), (c = q[a]), !b.equals(c))) return a;
				return a - 1;
			}
			function h() {
				var b = I - 1,
			...
			if (
				...
				(u.equals(F) || (u.type === CKEDITOR.NODE_ELEMENT && u.getFirst().equals(F)))
			)
				...
				C = c;
				for (W = I; W <= n; W++)
					if (((c = q[W]), (X = c.getPrevious()), c.equals(O[W]))) b && (C = C.getChild(0));
					else {
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark: function (a) {
				function b(a) {
					return a.getAscendant(function (a) {
						...
						if ((b = a.data && a.data('cke-temp')))
							b = -1 === CKEDITOR.tools.array.indexOf(['cke_copybin', 'cke_pastebin'], a.getAttribute('id'));
						return b;
					}, !0);
				}
				...
				e ||
					...
					(k = this.clone()),
					b(d) && ((d = b(d)), k.moveToPosition(d, CKEDITOR.POSITION_AFTER_END)),
					k.collapse(),
					k.insertNode(m));
				k = this.clone();
				...
				return { startNode: a ? h + (e ? 'C' : 'S') : f, endNode: a ? h + 'E' : m, serializable: a, collapsed: e };
			},
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						x.type == CKEDITOR.NODE_TEXT
							? (p && ((x = !CKEDITOR.tools.trim(x.substring(0, p)).length && x), (H = !!x)),
						...
						for (l = c(l); l || u; ) {
							if (l && !u) {
								...
								(H && 'inline' == l.getComputedStyle('display')) || ((H = !1), F ? (k = l) : this.setStartBefore(l));
								u = l.getPrevious();
							}
							for (; u; )
								if (((x = !1), u.type == CKEDITOR.NODE_COMMENT)) u = u.getPrevious();
								else {
									if (u.type == CKEDITOR.NODE_TEXT)
										(K = u.getText()), d.test(K) && (u = null), (x = /[\s\ufeff]$/.test(K));
									else if (
										(u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || (b && u.is('br'))) &&
										!u.data('cke-bookmark')
									)
										if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											...
											if (d.test(K)) u = null;
												...
												for (var p = u.$.getElementsByTagName('*'), D = 0, B; (B = p[D++]); )
									...
									x && (H ? (F ? (k = l) : l && this.setStartBefore(l)) : (H = !0));
									if (u) {
										x = u.getPrevious();
										if (!l && !x) {
											l = u;
						...
						x.type == CKEDITOR.NODE_TEXT
							? CKEDITOR.tools.trim(x.substring(p)).length
								? (H = !0)
								: ((H = !x.getLength()),
									p == x.getLength() ? (u = x.getNext()) || (l = x.getParent()) : f(x, p) && (l = x.getParent()))
							: (u = x.getChild(p)) || (l = x);
						for (; l || u; ) {
							if (l && !u) {
								!F && l.equals(m) && (F = !0);
								if (e ? l.isBlockBoundary() : !h.contains(l)) break;
								(H && 'inline' == l.getComputedStyle('display')) || ((H = !1), F ? (r = l) : l && this.setEndAfter(l));
								u = l.getNext();
							}
							for (; u; ) {
								x = !1;
								if (u.type == CKEDITOR.NODE_TEXT) (K = u.getText()), f(u, 0) || (u = null), (x = /^[\s\ufeff]/.test(K));
									...
									if ((0 < u.$.offsetWidth || (b && u.is('br'))) && !u.data('cke-bookmark'))
										if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
											...
											if (d.test(K)) u = null;
												...
												for (p = u.$.getElementsByTagName('*'), D = 0; (B = p[D++]); )
													if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
														u = null;
														break;
													}
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						this.setStartAt(
							G,
							!G.is('br') && ((!l && this.checkStartOfBlock()) || (l && G.contains(l)))
			...
			shrink: function (a, b, c) {
				...
				if (!this.collapsed) {
					...
					m &&
						...
						(k ? (k >= m.getLength() ? f.setStartAfter(m) : (f.setStartBefore(m), (c = 0))) : f.setStartBefore(m));
					h &&
						h.type == CKEDITOR.NODE_TEXT &&
						(l ? (l >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), (r = 0))) : f.setEndBefore(h));
					...
					c &&
						...
						this.setStartAt(m, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
					r &&
						(f.reset(),
						(f = f[a == CKEDITOR.SHRINK_ELEMENT ? 'lastBackward' : 'previous']()) &&
							this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
					return !(!c && !r);
				}
			},
			...
			splitBlock: function (a, b) {
				...
				'br' != a &&
					(e || ((e = this.fixBlock(!0, a)), (f = new CKEDITOR.dom.elementPath(this.endContainer, this.root).block)),
				...
				e &&
					e.equals(f) &&
					(d
						? ((m = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
						...
						: c
							? ((m = new CKEDITOR.dom.elementPath(this.startContainer, this.root)),
								...
								(e = null))
							: ((f = this.splitElement(e, b || !1)), e.is('ul', 'ol') || e.appendBogus()));
				return { previousBlock: e, nextBlock: f, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: m };
			},
			...
			removeEmptyBlocksAtEnd: (function () {
				...
				return function (b) {
					for (
						var c = this.createBookmark(), d = this[b ? 'endPath' : 'startPath'](), e = d.block || d.blockLimit, f;
			...
			moveToElementEditablePosition: function (a, b) {
				...
				for (var c = 0; a; ) {
					...
					var d = a,
						e = c,
						f = void 0;
					d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (f = d[b ? 'getLast' : 'getFirst'](r));
				...
				if (a && !a.is(CKEDITOR.dtd.$block)) d = 1;
					...
					(d = 1),
						...
						'false' == e.getAttribute('contenteditable')
							...
							: !CKEDITOR.env.needsBrFiller && f && e.is(CKEDITOR.dom.walker.validEmptyBlockContainers)
			...
			getClientRects: (function () {
				function a(b, c) {
					...
					c.startContainer instanceof CKEDITOR.dom.element &&
						(f = 0 === c.startOffset && c.startContainer.hasAttribute('data-widget'));
					c.endContainer instanceof CKEDITOR.dom.element &&
						(h =
							(h =
								c.endOffset ===
								(c.endContainer.getChildCount ? c.endContainer.getChildCount() : c.endContainer.length)) &&
							c.endContainer.hasAttribute('data-widget'));
					f && e.setStart(c.startContainer.getParent(), c.startContainer.getIndex());
						...
						? e.startContainer instanceof CKEDITOR.dom.element
							? ((a = e.checkStartOfBlock()),
								...
								a
									...
									: 0 === e.startOffset
										...
										: ((e = e.startContainer.getChildren().getItem(e.startOffset - 1)), g.insertAfter(e)),
								c.setStart(g.$, 0),
								c.setEnd(g.$, 0),
								(a = c.getClientRects()),
								g.remove())
							: e.startContainer instanceof CKEDITOR.dom.text &&
								('' === e.startContainer.getText()
									? (e.startContainer.setText('​'), (a = c.getClientRects()), e.startContainer.setText(''))
				...
				function d(a) {
					...
					a
						? (a.setText('​'), a.removeStyle('display'), (c = [b.getClientRect(), a.getClientRect()]), a.remove())
				...
				if (c && c.find)
					for (m = c.find(a), f = 0; f < m.count(); f++)
						if (((c = m.getItem(f)), b || !c.isReadOnly()))
							(h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c)),
								(k =
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					t.collapsed ||
						...
						(this._.lastNode && t.root.contains(this._.lastNode)) ||
							((this._.lastNode = this._.docEndMarker = t.document.createText('')), this._.lastNode.insertAfter(k)),
						(t = null));
					this._.started = 1;
					k = t;
				}
				...
				for (this._.nextNode = null; m; ) {
					...
					if (J) m.type == CKEDITOR.NODE_TEXT && f.test(m.getText()) && (J = 0);
						...
						if (CKEDITOR.dtd.$block[u] && 'false' == m.getAttribute('contenteditable')) {
							...
							b(this, a, d);
							break;
						} else if (m.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) {
							if ('br' == u) J = 1;
							...
							k && (k.setEndAt(m, CKEDITOR.POSITION_BEFORE_START), 'br' != u && (this._.nextNode = m));
							M = 1;
						} else {
							if (m.getFirst()) {
						...
						: !d || (this.enforceRealBlocks && d.is(l))
							...
							: 'li' != d.getName()
								? (k.checkStartOfBlock() && k.checkEndOfBlock()) ||
									...
									k.insertNode(d))
								: y ||
									(this._.nextNode = d.equals(t) ? null : this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, t));
				}
				z &&
					(z = d.getPrevious()) &&
				...
				A &&
					...
					z.remove();
				this._.nextNode || (this._.nextNode = y || d.equals(t) || !t ? null : this._getNextSourceNode(d, 1, t));
				return d;
			},
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				g = b[f];
				g = 'boolean' == typeof g ? {} : 'function' == typeof g ? { match: g } : D(g);
				...
				for (q in T) {
					...
					var B = n,
						...
						I = void 0;
					x ? (G = !1) : (x = {});
					for (I in h) '!' == I.charAt(0) && ((I = I.slice(1)), C.push(I), (x[I] = !0), (G = !1));
			...
			for (d = a.length; c < d; ++c) {
				...
				for (q in O) {
					...
					x = [];
					h = void 0;
					for (h in m) -1 < h.indexOf('*') ? x.push(new RegExp('^' + h.replace(/\*/g, '.*') + '$')) : x.push(h);
					m = x;
					m.length && ((n[p] = m), (B = !1));
				}
				n.nothingRequired = B;
					...
					if (
						...
						if (a)
							if (!0 === a) a = !0;
								...
								for (var f = 0, g = c.length, n; f < g; ++f) (n = c[f]), e[n] || (e[n] = a(n));
								a = !1;
							}
						else a = !1;
						d.allClasses = a;
		...
		function c(a, b, c) {
			if (!a.match || a.match(b)) {
				...
				b = b.classes;
				if (a) {
					for (var d = !1, e = !0 === a, g = b.length; g--; ) if (e || a(b[g])) b.splice(g, 1), (d = !0);
					a = d;
				} else a = !1;
		...
		function g(a) {
			...
			for (a = B(a); (b = a.match(q)); )
				(c = b[2]) ? ((d = w(c, 'styles')), (e = w(c, 'attrs')), (c = w(c, 'classes'))) : (d = e = c = null),
			...
			if (f.doFilter) {
				...
				if (!a.allAttributes)
					for (I in q)
						h[I] ||
							(T.test(I)
								? I == (l = I.replace(/^data-cke-saved-/, '')) || h[l] || (delete q[I], (x = !0))
								: (delete q[I], (x = !0)));
				...
				if (!a.allClasses || a.hadInvalidClass) {
					for (I = 0; I < B.length; ++I) (a.allClasses || p[B[I]]) && k.push(B[I]);
		...
		function J(a) {
			return a.type == CKEDITOR.NODE_ELEMENT && ('br' == a.name || p.$block[a.name]);
		}
		function E(a, b, c) {
			var d = a.name;
			if (p.$empty[d] || !a.children.length)
				'hr' == d && 'br' == b ? a.replaceWith(v()) : (a.parent && c.push({ check: 'it', el: a.parent }), a.remove());
				...
				if ('br' == b)
					...
					if (e) (a.name = b), (a.attributes = {}), c.push({ check: 'parent-down', el: a });
						...
						e = a.parent;
						for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || 'body' == e.name, q, B, g = d.length; 0 < g; )
							(n = d[--g]),
								f && (n.type == CKEDITOR.NODE_TEXT || (n.type == CKEDITOR.NODE_ELEMENT && p.$inline[n.name]))
									? (q ||
		...
		function F(a, b) {
			...
			for (f in d)
				if ('class' == f)
					for (c = d[f].split(/\s+/), n = a.classes.join('|'); (p = c.pop()); ) {
			...
			if (c && !b) {
				...
				!0 === d
					...
					: (d || (this.customConfig = !1),
						...
						this.allow(G[c.enterMode] + ' ' + G[c.shiftEnterMode], 'default', 1),
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function (a, b, c, d) {
					...
					function (a) {
						if (a.type == CKEDITOR.NODE_ELEMENT) {
							...
							a: {
								...
								1 == d.children.length && (p = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, p, c, B);
								c = !c.length;
							}
							c || f.push(a);
						}
				...
				for (var x; (c = f.pop()); ) c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove();
				for (; (D = a.pop()); )
					if (((c = D.el), c.parent))
						switch (((x = p[c.parent.name] || p.span), D.check)) {
							case 'it':
								p.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c) || E(c, d, a);
								break;
							case 'el-up':
								c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || E(c, d, a);
								break;
							case 'parent-down':
								c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || E(c.parent, d, a);
						}
				return q;
			},
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						for (g = 0; g < b.length; ++g)
							(n = b[g]),
								'string' == typeof n
									? ((n = n.split(/\s*:\s*/)), (p = n[0]), (q = null), (B = n[1]))
									: ((p = n.check), (q = n.left), (B = n.right)),
								f ||
									((f = n),
									(f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element)),
								q instanceof CKEDITOR.style && (q = x(q)),
								c.push({ check: p == f ? null : p, left: q, right: 'string' == typeof B ? K(B) : B });
						b = f;
						d[b] || (d[b] = []);
						d[b].push(c);
					}
			...
			check: function (a, b, c) {
				...
				if ('string' == typeof a) {
					...
					(e = a.getDefinition()),
						(n = e.styles),
						(d = e.attributes || {}),
						n && !CKEDITOR.tools.isEmpty(n) ? ((n = D(n)), (d.style = CKEDITOR.tools.writeCssText(n, !0))) : (n = {}),
						(e = {
							name: e.element,
							attributes: d,
				...
				z(this, n, p, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
				0 < p.length
					? (c = !1)
					: ((b = e.attributes['class']) && (e.attributes['class'] = e.attributes['class'].split(' ').sort().join(' ')),
		...
		C = CKEDITOR.filter.transformationsTools = {
			...
			transform: function (a, b) {
				if ('string' == typeof b) a.name = b;
					...
					for (f in e)
						if ('class' == f)
							for (c = a.classes.join('|'), g = e[f].split(/\s+/); (p = g.pop()); )
	...
	(function () {
		var a,
			d = function (b) {
				...
				a || (e && (a = !1 !== k.execCommand(e, { from: 'keystrokeHandler' })), a || (a = !!this.blockedKeystrokes[d]));
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function (a, d, b) {
			...
			for (var c = this.loaded, f = this.registered, e = [], k = {}, h = {}, l = 0; l < a.length; l++) {
				var r = a[l];
				if (r)
					...
					a.call(
						...
						function (a) {
							...
							for (g in a) {
									...
									if (h.icons)
										for (var z = h.icons.split(','), A = z.length; A--; )
											CKEDITOR.skin.addIcon(
												z[A],
												h.path + 'icons/' + (CKEDITOR.env.hidpi && h.hidpi ? 'hidpi/' : '') + z[A] + '.png',
											);
								...
								if (y) for (y.split && (y = y.split(',')), h = 0; h < y.length; h++) e[y[h]] || b.push(y[h]);
							}
							if (b.length) k.call(this, b);
							else {
								for (g in e)
									(h = e[g]),
										h.onLoad && !h.onLoad._called && (!1 === h.onLoad() && delete e[g], (h.onLoad._called = 1));
								c && c.call(f || window, e);
							}
						},
						this,
	...
	(function () {
		...
		function w(a) {
			...
			CKEDITOR.plugins.load(d.split(','), function (b) {
				...
				for (var g in b) {
					...
					if (q && (I = q.match(h)))
						for (; (q = I.pop()); )
							CKEDITOR.error('editor-plugin-required', { plugin: q.replace(',', ''), requiredBy: g });
					l &&
						!a.lang[g] &&
						(l.split && (l = l.split(',')),
					...
					if (!a.isDestroyed() && !a.isDetached()) {
						for (var b = ['beforeInit', 'init', 'afterInit'], f = 0; f < b.length; f++)
							for (var g = 0; g < d.length; g++) {
								var q = d[g];
								0 === f && e[g] && q.lang && q.langEntries && (a.lang[q.name] = q.langEntries[e[g]]);
								if (q[b[f]]) q[b[f]](a);
							}
			...
			for (var e = new CKEDITOR.dom.documentFragment(), f, g, h, k = 0; k < a.length; k++) {
				...
				c(l)
					? (f ||
							...
							f.append(p.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()),
							e.append(f),
		...
		CKEDITOR.editor.initializeDelayedEditorCreation = function (a, b, c) {
			if (b.delayIfDetached_callback)
				...
				var d =
					...
					e;
				CKEDITOR.warn('editor-delayed-creation', { method: 'interval - ' + d + ' ms' });
				e = setInterval(function () {
					a.isDetached() ||
						(clearInterval(e),
						CKEDITOR[c](a, b),
						CKEDITOR.warn('editor-delayed-creation-success', { method: 'interval - ' + d + ' ms' }));
				}, d);
			}
		};
		...
		CKEDITOR.editor.mergeDelayedCreationConfigs = function (a) {
			a &&
				((a.delayIfDetached =
					'boolean' === typeof a.delayIfDetached ? a.delayIfDetached : CKEDITOR.config.delayIfDetached),
				(a.delayIfDetached_interval = isNaN(a.delayIfDetached_interval)
					? CKEDITOR.config.delayIfDetached_interval
					: a.delayIfDetached_interval),
				(a.delayIfDetached_callback = a.delayIfDetached_callback || CKEDITOR.config.delayIfDetached_callback));
		};
	})();
	...
	(function () {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function (e, k, h) {
				...
				if (0 < m.length)
					for (var c = 0; c < m.length; c++) {
						...
						(g && !g[e]) || (a && f && !f[a] && CKEDITOR.dtd[a])
							...
							: (b || (r(), (b = 1)), (d = d.clone()), (d.parent = v), (v = d), m.splice(c, 1), c--);
					}
			}
			function r() {
			...
			A.onTagOpen = function (e, f, g, h) {
				...
				if (a(f)) m.push(f);
					...
					if ('br' == e) M.push(f);
						...
						for (
							;
							!((h = (g = v.name) ? CKEDITOR.dtd[g] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c),
							...
							if (v.isOptionalClose) A.onTagClose(g);
								...
								(g = v.children),
									((g = g[g.length - 1]) && 'li' == g.name) || w((g = new CKEDITOR.htmlParser.element('li')), v),
									!f.returnPoint && (f.returnPoint = v),
									(v = g);
							else if (e in CKEDITOR.dtd.$listItem && !z(e, g)) A.onTagOpen('li' == e ? 'ul' : 'dl', {}, 0, 1);
							else if (g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = v), (v = v.parent);
							else if ((g in CKEDITOR.dtd.$inline && m.unshift(v), v.parent)) w(v, v.parent, 1);
							else {
								f.isOrphan = 1;
								break;
							}
			...
			A.onText = function (a) {
				if (!((v._.hasInlineStarted && !M.length) || E || J) && ((a = CKEDITOR.tools.ltrim(a)), 0 === a.length)) return;
				var b = v.name,
					e = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
		...
		CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onElement: function (a, c) {
					for (
						var d = [this.elementsRules['^'], this.elementsRules[c.name], this.elementsRules.$], e, k = 0;
						3 > k;
						k++
					)
						if ((e = d[k])) {
			...
			exec: function (a, c) {
				...
				for (w = 0; w < h; w++)
					if (
						(d && ((l = c.type), (r = c.name)),
						(g = k[w]),
						!((a.nonEditable && !g.options.applyToAll) || (a.nestedEditable && g.options.excludeNestedEditable)))
					) {
	...
	(function () {
					...
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if (p)
							for (q(p, 1) && n.push(p); p; )
								e(p) && (B = c(p)) && q(B) && ((h = c(B)) && !e(h) ? n.push(B) : (g(D).insertAfter(B), B.remove())),
									(p = p.previous);
						for (p = 0; p < n.length; p++) n[p].remove();
						if ((n = !a || !1 !== ('function' == typeof d ? d(f) : d)))
							D || CKEDITOR.env.needsBrFiller || f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT
								? D ||
									CKEDITOR.env.needsBrFiller ||
									!(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem)
									? ((n = b(f)), (n = !n || ('form' == f.name && 'input' == n.name)))
									: (n = !1)
								: (n = !1);
						n && f.add(g(a));
					}
		...
		CKEDITOR.htmlDataProcessor = function (b) {
			...
			b.on(
				...
				function (a) {
					...
					c &&
						((p = e),
						!p.children.length && CKEDITOR.dtd[p.name][c] && ((c = new CKEDITOR.htmlParser.element(c)), p.add(c)));
					a.dataValue = e;
				},
				null,
				null,
				...
				elements: {
					...
					table: function (a) {
						a.children.slice(0).sort(function (a, b) {
							...
							a.type == CKEDITOR.NODE_ELEMENT &&
								b.type == a.type &&
								((c = CKEDITOR.tools.indexOf(E, a.name)), (d = CKEDITOR.tools.indexOf(E, b.name)));
		...
		var p = /<(a|area|img|input|source)\b([^>]*)>/gi,
			D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
			B = /^(href|src|name)$/i,
			G = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
		...
		m = (function () {
			...
			var d = [
				...
				new RegExp('((' + b('{cke_protected') + ')(_[0-9]*)?' + b('}') + ')', 'gi'),
				/<!(?:\s*-\s*){2,3}!?\s*>/g,
			];
			return function (b) {
	...
	(function () {
		CKEDITOR.inline = function (a, d) {
			...
			if (CKEDITOR.editor.shouldDelayEditorCreation(a, d))
				return CKEDITOR.editor.initializeDelayedEditorCreation(a, d, 'inline'), null;
			...
			b
				...
				: (d && 'undefined' !== typeof d.readOnly && !d.readOnly && a.setAttribute('contenteditable', 'true'),
					f.setData(c, null, !0));
			f.on(
				'loaded',
				function () {
		...
		CKEDITOR.inlineAll = function () {
			...
			for (b in CKEDITOR.dtd.$editable)
				for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, e = c.count(); f < e; f++)
					(a = c.getItem(f)),
	...
	(function () {
		function a(a, f, e, k) {
			...
			if (CKEDITOR.editor.shouldDelayEditorCreation(a, f))
				return CKEDITOR.editor.initializeDelayedEditorCreation(a, f, 'replace'), null;
		...
		function b(a) {
			...
			h && a.ui.space('top') && a.ui.space('top').unselectable();
			l && a.ui.space('bottom') && a.ui.space('bottom').unselectable();
			d = a.config.width;
			k = a.config.height;
			d && b.setStyle('width', CKEDITOR.tools.cssLength(d));
			k && a.ui.space('contents') && a.ui.space('contents').setStyle('height', CKEDITOR.tools.cssLength(k));
		...
		CKEDITOR.editor.prototype.setMode = function (a, b) {
			...
			if (a != d.mode && k && k[a]) {
				...
				if (d.mode) {
					...
					'source' == d.mode && k == l && (d.fire('lockSnapshot', { forceUpdate: !0 }), (r = 1));
	...
	(function () {
		function a(a) {
			...
			if (CKEDITOR.env.gecko || (CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller))
				if ((f = d(f, e)))
					f.appendBogus(), (k = (CKEDITOR.env.ie && !CKEDITOR.env.edge) || (CKEDITOR.env.edge && b._.previousActive));
			l(b, e.block, g) &&
				h.collapsed &&
		...
		function e(a) {
			return !!a.getRanges()[0].startPath().contains({ table: 1, ul: 1, ol: 1, dl: 1 });
		}
		function k(a) {
			function b(a) {
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
					...
					this.insertElementIntoRange(a, b) &&
						...
						g &&
							...
							g.is(CKEDITOR.dtd.$block)
								...
								: g ||
									e == CKEDITOR.ENTER_BR ||
									((g = b.fixBlock(!0, e == CKEDITOR.ENTER_DIV ? 'div' : 'p')), b.moveToElementEditStart(g))));
					d.selectRanges([b]);
					w(this);
				},
				...
				insertElementIntoRange: function (a, b) {
					...
					var h, k;
					if (f)
						for (; (h = b.getCommonAncestor(0, 1)) && (k = CKEDITOR.dtd[h.getName()]) && (!k || !k[e]); )
				...
				setup: function () {
					...
					if (!this.is('textarea')) {
						...
						if (B) {
							...
							G
								? B != G.getText() &&
									(CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? (G.$.styleSheet.cssText = B) : G.setText(B))
								: ((B = g.appendStyleText(B)),
									(B = new CKEDITOR.dom.element(B.ownerNode || B.owningElement)),
							...
							if (0 !== g.getRanges().length) {
								if (c in l) {
									...
									var p = b.startPath(),
										...
										c = 8 == c,
										r = !1;
									if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement())
										...
										if (b.checkStartOfBlock()) {
											...
											var t = K.getName();
											K = -1 !== CKEDITOR.tools.array.indexOf(['dd', 'dt', 'li'], t) && null === K.getPrevious();
										} else K = !1;
										if (K) {
										...
										? (a.fire('saveSnapshot'),
											r
												? ((d = b.startContainer.getAscendant(H, !0))
														? (b.setStart(d, 0), b.enlarge(CKEDITOR.ENLARGE_ELEMENT), (f = b))
														: (f = null),
													f.deleteContents())
												: (b.moveToPosition(f, CKEDITOR.POSITION_BEFORE_START), f.remove()),
											b.select(),
											a.fire('saveSnapshot'),
											(d = 1))
										: b.collapsed &&
											...
											b[c ? 'checkStartOfBlock' : 'checkEndOfBlock']()
												? (a.fire('saveSnapshot'),
													b[c ? 'checkEndOfBlock' : 'checkStartOfBlock']() && B.remove(),
												...
												: p.blockLimit &&
													  ...
													  b.checkBoundaryOfElement(D, c ? CKEDITOR.START : CKEDITOR.END) &&
													  (G = D[c ? 'getPrevious' : 'getNext'](z))
													? (a.fire('saveSnapshot'),
														b['moveToElementEdit' + (c ? 'End' : 'Start')](G),
														b.checkStartOfBlock() && b.checkEndOfBlock() ? G.remove() : b.select(),
														a.fire('saveSnapshot'),
														(d = 1))
						...
						CKEDITOR.env.gecko &&
							this.attachListener(this, 'mouseup', function (b) {
								if (
									2 == b.data.$.button &&
									((b = b.data.getTarget()), !b.getAscendant('table') && !b.getOuterHtml().replace(M, ''))
								) {
									var c = a.createRange();
											...
											(c = d),
												...
												f && d && !f.equals(d)
													? (a.fire('saveSnapshot'),
														...
														c.deleteContents(),
														d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), y(f, d, !0)),
		...
		v = (function () {
								...
								N && f in CKEDITOR.dtd.$list
									...
									: ((q = !!p[f]),
										'br' != f ||
											!e.data('cke-eol') ||
											(k && k != D - 1) ||
											((I = (g = k ? h[k - 1].node : B.getItem(k + 1)) && (!a(g) || !g.is('br'))),
			...
			function d(b, c) {
				...
				for (B && e.push(' '); h < f; h++) (q = g.getItem(h)), a(q) && !q.is(k) ? (e = e.concat(d(q, c))) : e.push(q);
				B && e.push(' ');
				return e;
			}
			function e(b) {
			...
			return function (q, C, L, w) {
				...
				if (!w.checkReadOnly()) {
					var z = new CKEDITOR.dom.elementPath(w.startContainer, w.root).blockLimit || w.root;
					C = {
						type: C,
						dontFilter: u,
						editable: q,
					...
					'text' == C.type &&
						...
						((S = CKEDITOR.dom.element.createFromHtml('\x3cspan\x3e\x26nbsp;\x3c/span\x3e', u.document)),
						u.insertNode(S),
						u.setStartAfter(S));
					...
					if (!u.collapsed) {
						...
						A && !A.equals(Z) && !A.contains(Z) && u.checkEndOfBlock() && C.zombies.push(A);
						u.deleteContents();
					}
					...
					if ((A = S.contains(f, !1, 1)))
						(y = u.splitElement(A)), (C.inlineStylesRoot = A), (C.inlineStylesPeak = S.lastElement);
					S = u.createBookmark();
					v && (g(A), g(y));
					...
					t.enterMode === CKEDITOR.ENTER_DIV &&
						y &&
						((t = q.getFirst()) && t.remove(), w.setStartAt(q, CKEDITOR.POSITION_AFTER_START), w.collapse(!0));
					if ((q = L)) {
						q = C.range;
						if ('text' == C.type && C.inlineStylesRoot) {
							w = C.inlineStylesPeak;
							t = w.getDocument().createText('{cke-peak}');
							for (y = C.inlineStylesRoot.getParent(); !w.equals(y); ) (t = t.appendTo(w.clone())), (w = w.getParent());
						...
						if ((J = q.startPath().block) && (1 != J.getChildCount() || !J.getBogus()))
							a: {
								var Q;
								if (1 == w.getChildCount() && a((Q = w.getFirst())) && Q.is(I) && !Q.hasAttribute('contenteditable')) {
									J = Q.getElementsByTag('*');
									q = 0;
									for (y = J.count(); q < y; q++) if (((t = J.getItem(q)), !t.is(N))) break a;
					...
					if (q) {
						...
						var R,
							...
							z =
								...
								!(u & (CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED)),
							t = b(C.dataWrapper, C);
						for (C.editor.enterMode !== CKEDITOR.ENTER_BR && k(t, Q); y < t.length; y++) {
							u = t[y];
							if ((v = u.isLineBreak))
								(v = Q),
									(A = w),
									...
									u.hasBlockSibling
										? (v = 1)
										: (V = v.startContainer.getAscendant(m.$block, 1)) && V.is({ div: 1, p: 1 })
											? ((F = V.getPosition(A)),
												F == CKEDITOR.POSITION_IDENTICAL || F == CKEDITOR.POSITION_CONTAINS
													? (v = 0)
													: ((A = v.splitElement(V)), v.moveToPosition(A, CKEDITOR.POSITION_AFTER_START), (v = 1)))
											: (v = 0);
							if (v) L = 0 < y;
							else {
								v = Q.startPath();
								!u.isBlock &&
									...
									P.appendBogus(),
									Q.insertNode(P),
									CKEDITOR.env.needsBrFiller && (E = P.getBogus()) && E.remove(),
								...
								if (S && u.isElement) {
									...
									if (v) A && ((U = Q.splitElement(A)), C.zombies.push(U), C.zombies.push(A));
									else {
										A = w.getName();
										R = !y;
										v = y == t.length - 1;
										...
										for (var Z = 0, Y = void 0, da = 0, fa = -1; Z < F; Z++)
											(Y = A[Z]),
												' ' == Y
													? (da || (R && !Z) || (V.push(new CKEDITOR.dom.text(' ')), (fa = V.length)), (da = 1))
													: (V.push(Y), (da = 0));
										v && fa == V.length && V.pop();
										R = V;
									}
								...
								u.lastNotAllowed &&
									y < t.length - 1 &&
									((U = z ? H : U) && Q.setEndAt(U, CKEDITOR.POSITION_AFTER_START), (S = 0));
								Q.collapse();
							}
						}
						1 != t.length
							? (E = !1)
							: ((E = t[0]), (E = E.isElement && 'false' == E.node.getAttribute('contenteditable')));
						E &&
							((L = !0),
							(v = t[0].node),
					...
					for (ca = E.createBookmark(); (P = C.zombies.pop()); )
						P.getParent() && ((U = E.clone()), U.moveToElementEditStart(P), U.removeEmptyBlocksAtEnd());
					if (R)
						for (; (P = R.pop()); ) CKEDITOR.env.needsBrFiller ? P.appendBogus() : P.append(E.document.createText(' '));
					for (; (P = C.mergeCandidates.pop()); ) P.mergeSiblings();
					CKEDITOR.env.webkit &&
						E.startPath() &&
						((P = E.startPath()), P.block ? P.block.$.normalize() : P.blockLimit && P.blockLimit.$.normalize());
					E.moveToBookmark(ca);
					if (!C.dontMoveCaret) {
						for (P = e(E); P && a(P) && !P.is(m.$empty); ) {
							if (P.isBlockBoundary()) E.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END);
							else {
		...
		J = (function () {
			...
			return function (d) {
				...
				g || (g = e);
				g.is('table')
					? (d.setStartAt(g, CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), g.remove())
			...
			tree: {
				rebuild: function (a, b) {
					...
					if (e.blockLimit.is({ tr: 1, table: 1 })) {
						...
						((g = g.contains(CKEDITOR.dtd.$list)), (c = c.contains(CKEDITOR.dtd.$list)), !g.equals(c))
					) {
			...
			return {
				list: {
					detectMerge: function (a, b) {
						...
						a.mergeListItems =
							e.block && g.block && e.block.is(CKEDITOR.dtd.$listItem) && g.block.is(CKEDITOR.dtd.$listItem);
					...
					function a(c) {
						...
						f.guard = function (a, f) {
							...
							if (f && h && a.equals(h)) (g = c.clone()), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g);
								...
								(g = c.clone()), g.setStartAt(k, CKEDITOR.POSITION_AFTER_START), e.push(g);
							else {
								if ((l = !f)) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
								if (!l && (l = f))
									if (a.is(d))
					...
					return {
						...
						deleteRanges: function (a) {
							for (var b; (b = a.tableContentsRanges.pop()); )
								b.extractContents(), t(b.startContainer) && b.startContainer.appendBogus();
	...
	(function () {
		...
		function d(b, c) {
			...
			if ((d = !c && 1 === b.length) && !(d = b[0].collapsed)) {
				...
				d && d.equals(f) && !d.findOne('td, th, tr, tbody, table')
					? ((g = g.cloneContents()), (d = g.getFirst() ? e(g.getFirst().getText()) !== e(d.getText()) : !0))
					: (d = !1);
			}
			if (d) return !1;
		...
		function e() {
			...
			if (b) {
				...
				if (!(e = !c) && (e = !c.isHidden())) {
					...
					var g = c.getRanges(),
						...
						N = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is('table');
			...
			c.compare(this._.selectionPreviousPath) ||
				...
				(!CKEDITOR.env.webkit && !CKEDITOR.env.gecko) || e || (this._.previousActive = this.document.getActive()),
			...
			return function (c) {
				...
				if (b[d]) {
					var e = a.getSelection(),
						g = e.getRanges()[0];
					e.isCollapsed() &&
						(g = g[38 > d ? 'getPreviousEditableNode' : 'getNextEditableNode']()) &&
						g.type == CKEDITOR.NODE_ELEMENT &&
		...
		CKEDITOR.on('instanceCreated', function (a) {
			...
			c.on('contentDom', function () {
				...
				function d(a) {
					...
					b ||
						((b = this.getSelection(1)), (c = g(b)) && !c.equals(n) && (b.selectElement(c), a.data.preventDefault()));
				}
				function g(a) {
					a = a.getRanges()[0];
					return a
					...
					n.attachListener(
						...
						function (a) {
							...
							0 !== D &&
								...
								a.isCollapsed &&
								a.anchorNode == n.$ &&
								((a = c.createRange()), a.moveToElementEditStart(n), a.select());
						},
						null,
						null,
						-2,
				...
				n.attachListener(
					...
					function () {
						if (D && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
							D = c._.previousActive && c._.previousActive.equals(f.getActive());
					...
					m
						...
						n.attachListener(
							...
							function () {
								...
								(CKEDITOR.env.gecko && !r && a) || (c.lockSelection(u), (D = 1));
							},
							null,
							null,
							-1,
				...
				if (CKEDITOR.env.ie && !r) {
					...
					n.attachListener(n, 'mouseup', function (a) {
						2 == a.data.$.button &&
							t &&
							((c.document.$.documentElement.scrollLeft = t.x), (c.document.$.documentElement.scrollTop = t.y));
						t = null;
					});
							...
							p.on('mousedown', function (a) {
								function b(a) {
									...
									if (y) {
										...
										y.setEndPoint(0 > v.compareEndPoints('StartToStart', c) ? 'EndToEnd' : 'StartToStart', c);
										y.select();
									}
								}
								function c() {
		...
		CKEDITOR.editor.prototype.getSelection = function (a) {
			return (!this._.savedSelection && !this._.fakeSelection) || a
				? (a = this.editable()) && 'wysiwyg' == this.mode && 'recreating' !== this.status
		...
		CKEDITOR.dom.selection.prototype = {
			getNative: function () {
				return void 0 !== this._.cache.nativeSel
					...
					: (this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection());
			},
			getType: m
				? function () {
						var a = this._.cache;
				...
				var a = m
					? (function () {
							...
							var b = function (b, c) {
								...
								for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, p = -1, r, m; k <= l; )
									if (
										((p = Math.floor((k + l) / 2)),
										(g = e[p]),
								...
								if (-1 == p || (p == e.length - 1 && 0 > r)) {
									...
									for (d = e.length; 0 < h && 0 < d; )
										(f = e[--d]), f.nodeType == CKEDITOR.NODE_TEXT && ((m = f), (h -= f.nodeValue.length));
								...
								for (; 0 < h; )
									try {
										(f = g[0 < r ? 'previousSibling' : 'nextSibling']),
											f.nodeType == CKEDITOR.NODE_TEXT && ((h -= f.nodeValue.length), (m = f)),
											(g = f);
									} catch (w) {
										return { container: d, offset: a(g) };
									}
								return { container: m, offset: 0 < r ? -h : m.nodeValue.length + h };
							};
							return function () {
								...
								if (d == CKEDITOR.SELECTION_ELEMENT) {
									for (var d = [], e = 0; e < c.length; e++) {
										for (
											var g = c.item(e), f = g.parentNode, h = 0, a = new CKEDITOR.dom.range(this.root);
					...
					c = CKEDITOR.tools.tryThese(
						...
						function () {
							for (
								...
								e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && K[c.getName()] && (d = c));
								e--
							)
			...
			selectRanges: function (a) {
				...
				if (c)
					for (var c = this.root, e, h = 0; h < a.length; ++h)
						(e = a[h]), e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount()));
				if (a.length)
					if (this.isLocked) {
						...
						a: {
							...
							if (
								...
								(l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT && (q = l),
						...
						if (q) this.fake(q);
							...
							if (m) {
								...
								if (
									(b.startContainer.type == CKEDITOR.NODE_ELEMENT && b.startContainer.getName() in N) ||
									(b.endContainer.type == CKEDITOR.NODE_ELEMENT && b.endContainer.getName() in N)
								)
								...
								k
									...
									: ((n = N.getNext(l)),
										...
										(n =
											...
											(C || !N.hasPrevious() || (N.getPrevious().is && N.getPrevious().is('br')))),
								...
								N.remove();
								a
									? (n ? (L.moveStart('character', -1), L.select(), b.document.$.selection.clear()) : L.select(),
								...
								for (L = 0; L < a.length; L++) {
									...
									b.collapsed &&
										...
										((q = g(this.root)),
										b.insertNode(q),
										(n = q.getNext()) && !q.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && 'br' == n.getName()
											? (w(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START))
	...
	(function () {
				...
				for (t.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t; ) {
					...
					if (t.equals(u)) (t = null), (l = !0);
						...
						var z = t.type == CKEDITOR.NODE_ELEMENT ? t.getName() : null,
							...
							x = z && -1 !== CKEDITOR.tools.array.indexOf(CKEDITOR.style.unstylableElements, z),
						...
						if (v && r && CKEDITOR.dtd.$block[z])
							for (
								var D = t, E = f(D), F = void 0, G = E.length, H = 0, D = G && new CKEDITOR.dom.range(D.getDocument());
								H < G;
								++H
							) {
								var F = E[H],
									J = CKEDITOR.filter.instances[F.data('cke-filter')];
								if (J ? J.check(this) : 1) D.selectNodeContents(F), b.call(this, D);
							}
						...
						if (E)
							if (
								...
								(G = g),
								(H = k),
								!F || (!(F.getDtd() || CKEDITOR.dtd.span)[G] && !H) || (E.parentRule && !E.parentRule(F)))
							)
								l = !0;
							else {
								if (
									(y ||
										(z && CKEDITOR.dtd.$removeEmpty[z] && (t.getPosition(u) | T) != T) ||
										((y = c.clone()), y.setStartBefore(t)),
									(z = t.type),
									z == CKEDITOR.NODE_TEXT || v || (z == CKEDITOR.NODE_ELEMENT && !t.getChildCount()))
								) {
									for (var z = t, K; (l = !z.getNext(B)) && ((K = z.getParent()), m[K.getName()]) && d(K, w, h, O); )
										z = K;
									y.setEndAfter(z);
								}
							}
						...
						for (
							...
							if (x.getName() == g) {
								for (U in h.attributes)
									!G[U] && (Y = x.getAttribute(R)) && (l.getAttribute(U) == Y ? (E[U] = 1) : (G[U] = 1));
								for (R in h.styles) !F[R] && (Y = x.getStyle(R)) && (l.getStyle(R) == Y ? (z[R] = 1) : (F[R] = 1));
							}
							x = x.getParent();
						}
		...
		function c(a) {
			...
			if (a.collapsed) {
				for (
					var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, k;
					h < g.elements.length && (k = g.elements[h]) && k != g.block && k != g.blockLimit;
					h++
				)
					if (this.checkElementRemovable(k)) {
						...
						!e &&
						a.collapsed &&
						(a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START)))
				...
				for (g = d; !g.equals(r); )
					(f = g.getNextSourceNode()),
						g.type == CKEDITOR.NODE_ELEMENT &&
							...
							(g.getName() == this.element ? z.call(this, g) : t(g, E(this)[g.getName()]),
		...
		function h(a) {
			...
			for (var d, e = a.document, g; (d = c.getNextParagraph()); )
				!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && ((g = M(this, e, d)), r(d, g));
			a.moveToBookmark(b);
		}
		function l(a) {
		...
		function z(a, b) {
			var c = this._.definition,
				...
				f;
			for (f in d)
				if (('class' != f && !this._.definition.fullMatch) || a.getAttribute(f) == u(f, d[f]))
		...
		function A(a) {
			for (var b = E(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e; )
		...
		function E(a) {
			...
			if (c) {
				...
				for (var d = 0; d < c.length; d++) {
					...
					'string' == typeof e
						? (g = e.toLowerCase())
						: ((g = e.element ? e.element.toLowerCase() : a.element), (f = e.attributes));
					e = b[g] || (b[g] = {});
					if (f) {
		...
		CKEDITOR.style = function (a, b) {
			...
			this.type = a.type || (x[c] ? CKEDITOR.STYLE_BLOCK : K[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
	...
	(function () {
		if (window.Promise) CKEDITOR.tools.promise = Promise;
			...
			if ('function' === typeof window.define && window.define.amd && 'function' === typeof window.require)
	...
	(function () {
		...
		CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
			var b = this.getRanges()[0],
				f = this.root.editor,
				e;
			if (this.root.editor._.shiftPressed || this.isFake || b.isCollapsed || b.startContainer.equals(b.endContainer))
				e = !1;
	...
	(function () {
		function a(a, c) {
			...
			else if (('string' === typeof a && a.match(/^\d+$/gm)) || ('string' === typeof a && a.match(/^\d+(?:deg)?$/gm)))
				a = parseInt(a, 10);
			return a;
		}
		function d(a, c) {
			...
			proto: {
				...
				getHsl: function () {
					...
					this._.type === CKEDITOR.tools.color.TYPE_HSL && a
						...
						: ((a = this._.blendAlphaColor(this._.red, this._.green, this._.blue, this._.alpha)),
			...
			_: {
				...
				blendAlphaColor: function (a, b, c, d) {
					return CKEDITOR.tools.array.map([a, b, c], function (a) {
						return Math.round(
							CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE - d * (CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE - a),
						);
					});
				},
						...
						(a = b || c || a)
							? ((this._.type = a.type),
								...
								a.type === CKEDITOR.tools.color.TYPE_HSL &&
									((this._.hue = a.hue), (this._.saturation = a.saturation), (this._.lightness = a.lightness)))
				...
				extractColorChannelsFromHex: function (a) {
					...
					if (!a.match(CKEDITOR.tools.color.hex6CharsRegExp) && !a.match(CKEDITOR.tools.color.hex8CharsRegExp))
						return null;
					a = a.split('');
					var b = 1;
					a[7] &&
				...
				extractColorChannelsFromRgba: function (b) {
					...
					c = { type: CKEDITOR.tools.color.TYPE_RGB, red: b, green: l, blue: r, alpha: g };
				...
				extractColorChannelsFromHsla: function (b) {
					...
					var f = 4 === c.length,
						...
						r = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
					...
					return this._.areColorChannelsValid(b[0], b[1], b[2], b[3]) ? c : null;
				},
		...
		CKEDITOR.dom.elementPath = function (b, f) {
			...
			do
				if (l.type == CKEDITOR.NODE_ELEMENT) {
					...
					if (
						!this.lastElement &&
						((this.lastElement = l), l.is(CKEDITOR.dtd.$object) || 'false' == l.getAttribute('contenteditable'))
					)
						continue;
					if (l.equals(f)) break;
					if (
						!k &&
						((r = l.getName()), 'true' == l.getAttribute('contenteditable') ? (k = l) : !e && d[r] && (e = l), a[r])
					) {
						if ((r = !e && 'div' == r)) {
							a: {
								r = l.getChildren();
			...
			createIterator: function () {
				...
				return {
					getNextRange: function (k) {
						...
						var h = a[e];
						if (h && 1 < a.length) {
							if (!e) for (var l = a.length - 1; 0 <= l; l--) d.unshift(a[l].createBookmark(!0));
							if (k)
								for (var r = 0; a[e + r + 1]; ) {
									var g = h.document;
									k = 0;
							...
							for (h.moveToBookmark(d.shift()); r--; )
								(l = a[++e]), l.moveToBookmark(d.shift()), h.setEnd(l.endContainer, l.endOffset);
						}
						return h;
					},
				};
		...
		function d(b) {
			...
			if (c)
				for (
					...
					if (
						((f = c[e]),
						d.ie && (f.replace(/^ie/, '') == d.version || (d.quirks && 'iequirks' == f)) && (f = 'ie'),
						d[f])
					) {
						b += '_' + c[e];
						break;
			...
			if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
				...
				a = function (a) {
					...
					if (!a.getById('cke_ui_color')) {
						...
						(a = b.getUiColor()) && f([d], CKEDITOR.skin.chameleon(b, 'panel'), [[l, a]]);
					}
				};
				b.on('panelShow', a);
				b.on('menuShow', a);
...
*/
	...
	(function () {
		...
		function ca(a) {
			...
			a.parts.title.on(
				...
				function (f) {
					...
					d = a.getPosition();
					CKEDITOR.env.ie6Compat && ((g = u.getChild(0).getFrameDocument()), g.on('mousemove', b), g.on('mouseup', c));
		...
		function da(a) {
			function b(b) {
				...
				A = Math.floor(A);
				w = Math.floor(w);
				if (d == CKEDITOR.DIALOG_RESIZE_WIDTH || d == CKEDITOR.DIALOG_RESIZE_BOTH) n = Math.max(e.minWidth || 0, w - g);
		...
		function P(a) {
			...
			f
				...
				: ((d = [
					...
					CKEDITOR.env.ie6Compat &&
						((e = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + e + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e"),
						d.push(
		...
		CKEDITOR.dialog = function (a, b) {
			...
			function d(b) {
				if (m == CKEDITOR.dialog._.currentTop) {
					...
					if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), (q = 1);
						...
						(c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? J.call(m) : W.call(m)),
							m.selectPage(c),
							m._.tabs[c][0].focus(),
							(q = 1);
			...
			var g = CKEDITOR.dialog._.dialogDefinitions[b],
				...
				q,
				n;
			(('OS' == p && CKEDITOR.env.mac) || ('rtl' == p && 'ltr' == l) || ('ltr' == p && 'rtl' == l)) &&
				k.buttons.reverse();
			...
			if (a._.removeDialogTabs && (h = a._.removeDialogTabs[b])) for (l = 0; l < h.length; l++) g.removeContents(h[l]);
			...
			this.on(
				...
				function () {
					...
					a.config.dialog_startupFocusTab && b
						? ((m._.tabBarMode = !0), m._.tabs[m._.currentTabId][0].focus(), (m._.currentFocusIndex = -1))
						: this._.hasFocus ||
			...
			this.parts.tabs.on(
				...
				function (a) {
					...
					b.hasClass('cke_dialog_tab') &&
						((b = b.$.id), this.selectPage(b.substring(4, b.lastIndexOf('_'))), I(this), a.data.preventDefault());
				},
				this,
			);
			l = [];
			h = CKEDITOR.dialog._.uiElementBuilders.hbox
				.build(this, { type: 'hbox', className: 'cke_dialog_footer_buttons', widths: [], children: g.buttons }, l)
				.getChild();
		...
		CKEDITOR.dialog.prototype = {
			...
			resize: function (a, b) {
				if (!this._.contentSize || this._.contentSize.width != a || this._.contentSize.height != b) {
					...
					if ('rtl' == this._.editor.lang.dir && this._.position) {
						...
						this._.position.x =
							c - this._.contentSize.width - parseInt(this._.element.getFirst().getStyle('right'), 10);
					}
						...
						if (e) {
							for (var g in this._.contents[a.id]) {
								...
								'hbox' != k.type &&
									'vbox' != k.type &&
									k.getInputElement() &&
									(k.requiredContent && !this._.editor.activeFilter.check(k.requiredContent)
										? k.disable()
										: (k.enable(), f++));
							}
			...
			addPage: function (a) {
				if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
					...
					a.accessKey &&
						(T(this, this, 'CTRL+' + a.accessKey, ga, fa), (this._.accessKeyMap['CTRL+' + a.accessKey] = a.id));
				}
			},
			...
			hidePage: function (a) {
				...
				b &&
					1 != this._.pageCount &&
					b.isVisible() &&
					(a == this._.currentTabId && this.selectPage(J.call(this)), b.hide(), this._.pageCount--, this.updateStyle());
			},
			showPage: function (a) {
				...
				if (this.state != a) {
					...
					if (a == CKEDITOR.DIALOG_STATE_BUSY) {
						...
						a == CKEDITOR.DIALOG_STATE_IDLE &&
							(this.parts.spinner && this.parts.spinner.hide(), this.getButton('ok') && this.getButton('ok').enable());
					this.fire('state', a);
				}
			},
			getModel: function (a) {
			...
			CKEDITOR.ui.dialog = {
				uiElement: function (a, b, c, e, d, f, g) {
					if (!(4 > arguments.length)) {
						...
						for (var m = h['class'] && h['class'].split ? h['class'].split(' ') : [], n = 0; n < m.length; n++)
							m[n] && (r[m[n]] = 1);
						m = [];
						for (n in r) m.push(n);
						h['class'] = m.join(' ');
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			openDialog: function (a, b, c) {
				...
				if ('function' == typeof d)
					...
					if ('failed' == d)
						throw (Q(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.'));
					'string' == typeof d &&
						CKEDITOR.scriptLoader.load(
							CKEDITOR.getUrl(d),
							function () {
		...
		CKEDITOR.ui.button.prototype = {
			render: function (a, b) {
				function c() {
					var f = a.mode;
					f &&
						((f = this.modes[f] ? (void 0 !== p[f] ? p[f] : CKEDITOR.TRISTATE_OFF) : CKEDITOR.TRISTATE_DISABLED),
				...
				d
					? (m = a.getCommandKeystroke(d)) && (k = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, m))
					: (g += 'off');
				...
				this.icon && !/\./.test(this.icon)
					? ((n = this.icon), (t = null))
					: (this.icon && (h = this.icon), CKEDITOR.env.hidpi && this.iconHiDpi && (h = this.iconHiDpi));
	...
	(function () {
		...
		function x(a) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomCopyCutSupported) {
					var c = function (b) {
						a.getSelection().isCollapsed() ||
							((a.readOnly && 'cut' == b.name) || n.initPasteDataTransfer(b, a), b.data.preventDefault());
					};
					b.on('copy', c);
					b.on('cut', c);
					b.on(
				...
				return {
					...
					exec: function (a, b) {
						function c(b, h) {
							...
							b
								? ((b.method = 'paste'), b.dataTransfer || (b.dataTransfer = n.initPasteDataTransfer()), u(a, b, h))
								: k && !a._.forcePasteDialog && a.showNotification(e, 'info', a.config.clipboard_notificationDuration);
						...
						h && !0 !== a.config.forcePasteAsPlainText && 'allow-word' !== a.config.forcePasteAsPlainText
							? (a._.nextPasteType = h)
			...
			function k(b, c) {
				...
				if (!d.getById('cke_pastebin')) {
					...
					var m = new CKEDITOR.dom.element(
						(!CKEDITOR.env.webkit && !h.is('body')) || CKEDITOR.env.ie ? 'div' : 'body',
						d,
					);
					...
					CKEDITOR.env.webkit
						? (h.append(m),
							...
							h.is('body') ||
								((g = 'static' != h.getComputedStyle('position') ? h : CKEDITOR.dom.element.get(h.$.offsetParent)),
					...
					(g = m.getParent().isReadOnly())
						...
						: m.setStyle('ltr' == a.config.contentsLangDirection ? 'left' : 'right', '-10000px');
					a.on('selectionChange', k, null, null, 0);
					if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) f = h.once('blur', k, null, null, -100);
					g && m.focus();
					...
					setTimeout(function () {
						...
						m.remove();
						var b;
						CKEDITOR.env.webkit && (b = m.getFirst()) && b.is && b.hasClass('Apple-style-span') && (m = b);
			...
			function r() {
				if ('paste' == n.mainPasteEvent) return a.fire('beforePaste', { type: 'auto', method: 'paste' }), !1;
				a.focus();
				e();
				var b = a.focusManager;
				b.lock();
				if (a.editable().fire(n.mainPasteEvent) && !f('paste')) return b.unlock(), !1;
				b.unlock();
				return !0;
			}
			function h(b) {
			...
			function m(b) {
				var c = { type: 'auto', method: 'paste', dataTransfer: n.initPasteDataTransfer(b) };
			...
			(function () {
				function b(c, d, h, k, f) {
					...
					a.addCommand(d, h);
					a.ui.addButton && a.ui.addButton(c, { label: m, command: d, toolbar: 'clipboard,' + k });
					a.addMenuItems && a.addMenuItem(d, { label: m, command: d, group: 'clipboard', order: f });
				}
			...
			init: function (a) {
				function b(b) {
					b = CKEDITOR.tools.array
						...
						.join(', ');
					return a.lang.clipboard.fileFormatNotSupportedNotification.replace(/\${formats\}/g, b);
				}
				function c(a, b) {
					return (CKEDITOR.env.ie && a.data.fileTransferCancel) || !(CKEDITOR.env.ie || (b && l !== b.id))
						? !1
				...
				a.config.forcePasteAsPlainText
					...
					: a.config.pasteFilter
						...
						: !CKEDITOR.env.webkit || 'pasteFilter' in a.config || (d = 'semantic-content');
				a.pasteFilter = e.get(d);
				x(a);
				D(a);
				CKEDITOR.dialog.add('paste', CKEDITOR.getUrl(this.path + 'dialogs/paste.js'));
				if (
					(CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || CKEDITOR.plugins.clipboard.isFileApiSupported) &&
					...
					a.on(
						...
						function (b) {
							...
							if (!d.dataValue && c(b, h))
								if (((h = h.getFile(0)), -1 === CKEDITOR.tools.indexOf(g, h.type)))
				...
				a.on(
					...
					function (b) {
						...
						var c = a._.nextPasteType || b.type,
							...
							l = b.dataTransfer.getTransferType(a) == CKEDITOR.DATA_TRANSFER_EXTERNAL,
						...
						else if ((l && a.pasteFilter && !b.dontFilter) || n) d = w(a, d, a.pasteFilter);
		...
		CKEDITOR.plugins.clipboard = {
			isCustomCopyCutSupported:
				(CKEDITOR.env.ie && 16 > CKEDITOR.env.version) || (CKEDITOR.env.iOS && 605 > CKEDITOR.env.version) ? !1 : !0,
			...
			internalDrop: function (a, b, c, d) {
				...
				CKEDITOR.env.ie &&
					10 > CKEDITOR.env.version &&
					this.fixSplitNodesAfterDrop(a, b, e.dragStartContainerChildCount, e.dragEndContainerChildCount);
				(l = this.isDropRangeAffectedByDragRange(a, b)) || (f = a.createBookmark(!1));
				...
				b = d.createRange();
				e.startNode.getCommonAncestor(g) || (e = d.getSelection().createBookmarks()[0]);
				b.moveToBookmark(e);
			...
			getRangeAtDropPosition: function (a, b) {
				...
				if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, e))
		...
		p = CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? 'cke/id' : 'Text';
		CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
			...
			b &&
				...
				'Text' == p || this.getData('text/plain') || this.setData('text/plain', b.getSelection().getSelectedText()));
		};
		...
		CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
			...
			setData: function (a, b) {
				...
				if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || 'URL' == a || 'Text' == a)
					if (('Text' == p && 'Text' == a && (this.id = b), this._.fallbackDataTransfer.isRequired()))
			...
			cacheData: function () {
				...
				if (this.$) {
					...
					if ((e = (this.$ && this.$.files) || null) || d) {
						this._.files = [];
						if (e && e.length) for (c = 0; c < e.length; c++) this._.files.push(e[c]);
			...
			_stripHtml: function (a) {
				function b(a) {
					...
					b.parse(a);
					return 'number' !== typeof e || 'number' !== typeof g ? a : a.substring(e, g).replace(/<\/body\s*>$/gi, '');
				}
				a &&
					a.length &&
								...
								function (a) {
									...
									if ('input' !== a.data.getTarget().getName() || (37 !== b && 39 !== b))
										this._.onKeyDown && !1 === this._.onKeyDown(b)
											? ('input' === a.data.getTarget().getName() && 32 === b) || a.data.preventDefault()
											: (27 == b || b == ('rtl' == c ? 39 : 37)) &&
												this.onEscape &&
												!1 === this.onEscape(b) &&
												a.data.preventDefault();
	...
	CKEDITOR.plugins.add('menu', {
		...
		beforeInit: function (m) {
			for (
				var k = m.config.menu_groups.split(','), n = (m._.menuGroups = {}), r = (m._.menuItems = {}), p = 0;
				p < k.length;
				p++
			)
				n[k[p]] = p + 1;
	...
	(function () {
		...
		CKEDITOR.env.gecko &&
			(k += ' onblur\x3d"this.style.cssText \x3d this.style.cssText;" ondragstart\x3d"return false;"');
		CKEDITOR.env.ie &&
			(n =
			...
			proto: {
				...
				show: function (a, b, f, c) {
					...
					for (
						...
						var q = h[p];
						n != q.group &&
							(d.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'), (n = q.group));
						q.render(this, p, d);
					}
					d.push('\x3c/div\x3e');
					e.setHtml(d.join(''));
			...
			proto: {
				render: function (a, b, f) {
					...
					this.command &&
						...
						(e = g.getCommandKeystroke(e)) && (d = CKEDITOR.tools.keystrokeToString(g.lang.common.keyboard, e)));
				...
				if ((b = b || y(a))) {
					...
					if (c && f && k) {
						...
						if (c.is('li') || c.getParent().is('li')) {
							...
							if (d.is('li'))
								b || h ? (b && h && f.remove(), c[h ? 'insertAfter' : 'insertBefore'](d)) : c.breakParent(d);
							else {
								if (a)
									if (
										(p.block.is('li')
					...
					if ((q = b.splitBlock(m))) {
						...
						c
							...
							: a &&
								(h = a.getParent()) &&
								h.is('li') &&
								(a.breakParent(h), (h = a.getNext()), b.moveToElementEditStart(h), a.move(a.getPrevious()));
						if (f || k)
							if (n(e)) b.moveToElementEditStart(b.getTouchedStartNode());
								...
								d
									...
									: h && h.is('li')
										? (d = h)
										: ((d = g.createElement(m)), a && (t = a.getDirection()) && d.setAttribute('dir', t));
								if ((g = q.elementPath))
							...
							c.is('li') &&
								...
								(h = d.next()) &&
									...
									h.is('ul', 'ol') &&
									(CKEDITOR.env.needsBrFiller ? g.createElement('br') : g.createText(' ')).insertBefore(h)),
			...
			enterBr: function (a, e, b, l) {
				if ((b = b || y(a))) {
					...
					l || 'li' != p
						? (!l && g && w.test(p)
								? (g = k.getDirection())
									? ((n = n.createElement('div')), n.setAttribute('dir', g), n.insertAfter(k), b.setStart(n, 0))
	...
	(function () {
		...
		function l(a, c, b) {
			...
			this.lang = a.lang;
			'string' === typeof c
				? ((this.data = c), (this.file = n(this.data)), (this.loaded = this.total = this.file.size))
					...
					if ('abort' != b.status)
						if (((b.uploaded = b.uploadTotal), 200 > d.status || 299 < d.status))
							(b.message = b.lang.filetools['httpError' + d.status]),
								b.message || (b.message = b.lang.filetools.httpError.replace('%1', d.status)),
		...
		function l(a, b, d, c) {
			if (c && c.length)
				for (var e, g = c.length; g--; )
					if (
						((e = c[g]),
						('hbox' != e.type && 'vbox' != e.type && 'fieldset' != e.type) || l(a, b, d, e.children),
						e.filebrowser)
					)
						if (
			...
			if ('function' != typeof b || !1 !== b.call(this._.filebrowserSe))
				if (!e || !1 !== e.call(this._.filebrowserSe, a, b))
					if (
						...
						a && ((c = this._.filebrowserSe), (d = c.getDialog()), (c = c.filebrowser.target || null)))
					)
						if (((c = c.split(':')), (e = d.getContentElement(c[0], c[1])))) e.setValue(a), d.selectPage(c[0]);
		}
				...
				for (var b = a.data.definition, d, c = 0; c < b.contents.length; ++c)
					if ((d = b.contents[c]))
						l(a.editor, a.data.name, b, d.elements),
							d.hidden && d.filebrowser && (d.hidden = !h(b, d.id, d.filebrowser));
		});
	})();
	(function () {
		function k(a) {
	...
	CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
		...
		proto: {
			...
			attribute: function (b, a) {
				'string' == typeof a &&
					((a = CKEDITOR.tools.htmlEncodeAttr(a)), this.forceSimpleAmpersand && (a = a.replace(/&amp;/g, '\x26')));
	...
	(function () {
		function v(a) {
			function d(a) {
				...
				h.attachListener(
					...
					'keydown',
					function () {
						var f = c.getBody().getElementsByTag(a);
						if (!b) {
							for (var d = 0; d < f.count(); d++) f.getItem(d).setCustomData('retain', !0);
							b = !0;
						}
					},
					null,
			...
			if (b && !b.isDetached()) {
				...
				e.contentEditable = !0;
				CKEDITOR.env.ie && ((e.hideFocus = !0), (e.disabled = !0), e.removeAttribute('disabled'));
				...
				CKEDITOR.env.ie && !CKEDITOR.env.edge && b.enterMode != CKEDITOR.ENTER_P
					? d('p')
					: CKEDITOR.env.edge && 15 > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && d('div');
				...
				e = b.document.getElementsByTag('title').getItem(0);
		...
		function w(a) {
			...
			else CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && d();
		}
		function x() {
			var a = [];
			if (8 <= CKEDITOR.document.$.documentMode) {
				...
				var d = [],
					b;
				for (b in CKEDITOR.dtd.$removeEmpty) d.push('html.CSS1Compat ' + b + '[contenteditable\x3dfalse]');
				...
				a.addMode('wysiwyg', function (d) {
					function b(b) {
						...
						if (
							!a.isDestroyed() &&
							!a.isDetached() &&
							(a.editable(new l(a, g.getFrameDocument().getBody())), a.setData(a.getData(1), d), t)
						) {
							if (u) a.on('mode', c, { iframe: g, editor: a, callback: d });
							a.on('mode', function () {
								a.status = 'ready';
							});
							e();
					...
					function e() {
						m = new MutationObserver(function (b) {
							for (var c = 0; c < b.length; c++) {
								var d = b[c];
								if ('childList' === d.type && 0 !== d.addedNodes.length)
									for (var e = 0; e < d.addedNodes.length; e++) {
										var g = d.addedNodes[e];
										g.contains && g.contains(a.container.$) && (u ? (p = !0) : f());
									}
							}
						});
					...
					function f() {
						...
						a.editable(c);
						a.status = 'recreating';
						a.setData(b, { callback: d, internal: !1, noSnapshot: !1 });
					}
					var h =
							'document.open();' +
							(CKEDITOR.env.ie ? '(' + CKEDITOR.tools.fixDomain + ')();' : '') +
						...
						g = CKEDITOR.dom.element.createFromHtml(
							'\x3ciframe src\x3d"' + h + '" frameBorder\x3d"0"\x3e\x3c/iframe\x3e',
						);
					...
					if (n) {
						var k = CKEDITOR.tools.getNextId(),
							q = CKEDITOR.dom.element.createFromHtml(
								'\x3cspan id\x3d"' + k + '" class\x3d"cke_voice_label"\x3e' + n + '\x3c/span\x3e',
							);
						h && h.append(q, 1);
			...
			proto: {
				...
				setData: function (a, d) {
					...
					if (d) this.setHtml(a), this.fixInitialSelection(), b.fire('dataReady');
						...
						e || (h += CKEDITOR.tools.buildStyleHtml(b.config.contentsCss));
			...
			getEditorAnchors: function (c) {
				for (
					...
					(d.data('cke-saved-name') || d.hasAttribute('name')) &&
						e.push({ name: d.data('cke-saved-name') || d.getAttribute('name'), id: d.getAttribute('id') });
				for (f = 0; (d = a.getItem(f++)); )
					(d = this.tryRestoreFakeAnchor(c, d)) && e.push({ name: d.getAttribute('name'), id: d.getAttribute('id') });
				return e;
			},
			fakeAnchor: !0,
		...
		CKEDITOR.removeAnchorCommand.prototype = {
			exec: function (c) {
				...
				if (
					...
					e.hasAttribute('href')
						? (e.removeAttributes({ name: 1, 'data-cke-saved-name': 1 }), e.removeClass('cke_anchor'))
						: e.remove(1);
				b.selectBookmarks(a);
			},
					...
					if (q.indent == p) {
						...
						m.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
							...
							(CKEDITOR.env.needsBrFiller &&
								...
								n.is('br') &&
								n.remove(),
							((n = m.getLast(t)) && n.type == CKEDITOR.NODE_ELEMENT && n.is(CKEDITOR.dtd.$block)) ||
				...
				if (l)
					for (a = h.getFirst(); a; ) {
						if (
							...
							a.getName() in CKEDITOR.dtd.$listItem && ((d = a), (b = e = f = void 0), (f = d.getDirection())))
						) {
				...
				for (
					...
					for (k.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; (m = k.getNextParagraph()); )
						if (!m.getCustomData('list_block') && !f(m)) {
							...
							for (
								var y = a.elementPath(m), n = y.elements, r = 0, y = y.blockLimit, q, w = n.length - 1;
								0 <= w && (q = n[w]);
								w--
							)
				...
				for (q = []; 0 < h.length; )
					(n = h.shift()),
						this.state == CKEDITOR.TRISTATE_OFF
							...
							: this.state == CKEDITOR.TRISTATE_ON && u[n.root.getName()] && !l(n) && N.call(this, a, n, c);
							...
							if (e && e.collapsed) {
								...
								if (b) {
									...
									(c = A(c))
										...
										: (k.range.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
											...
											(c = k.previous()) &&
												...
												(c.is('li') ||
													(k.range.selectNodeContents(c), k.reset(), (k.evaluator = H), (c = k.previous())),
												(f = c),
									...
									if (f) D(a, d, e), l.cancel();
										...
										p &&
											...
											e.checkBoundaryOfElement(f, CKEDITOR.START) &&
												((c = p.getPrevious(t)),
												A(f) ? c && (e.moveToElementEditEnd(c), e.select()) : a.execCommand('outdent'),
												l.cancel()));
									}
									...
									if (
										...
										(g = 0),
										(c = k.next()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in u && c.equals(h)
											? ((g = 1), (c = k.next()))
										...
										2 == g &&
											(d.moveToPosition(d.endPath().block, CKEDITOR.POSITION_BEFORE_END),
											e.endPath().block && e.moveToPosition(e.endPath().block, CKEDITOR.POSITION_AFTER_START));
										D(a, d, e);
										l.cancel();
									}
								} else
			...
			init: function (a) {
				...
				if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
					...
					if (a.config.maximize_historyIntegration)
						c.on(
							a.config.maximize_historyIntegration === CKEDITOR.HISTORY_NATIVE ? 'popstate' : 'hashchange',
							function () {
								var b = a.getCommand('maximize');
								b.state === CKEDITOR.TRISTATE_ON && b.exec();
							},
						);
				}
			},
	...
	(function () {
		...
		CKEDITOR.ajax = (function () {
			...
			function l(a, b, c, e, d) {
				...
				f.setRequestHeader('Content-type', c || 'application/x-www-form-urlencoded; charset\x3dUTF-8');
				f.send(b);
			}
			return {
				load: function (a, b, c) {
	...
	(function () {
		...
		CKEDITOR.plugins.pastetools = {
			...
			getClipboardData: function (a, b) {
				var d;
				return CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || 'text/html' === b
			...
			getContentGeneratorName: function (a) {
				if ((a = /<meta\s+name=["']?generator["']?\s+content=["']?(\w+)/gi.exec(a)) && a.length)
					return (
						(a = a[1].toLowerCase()),
						0 === a.indexOf('microsoft') ? 'microsoft' : 0 === a.indexOf('libreoffice') ? 'libreoffice' : 'unknown'
					);
			},
		};
				...
				a.pasteTools.register({
					...
					handle: function (e, b) {
						...
						if (!1 !== a.fire('pasteFromWord', c) || f) {
							d.dontFilter = !0;
							if (f || !a.config.pasteFromWordPromptCleanup || confirm(a.lang.pastefromword.confirmCleanup))
								(c.dataValue = CKEDITOR.cleanWord(c.dataValue, a)),
									CKEDITOR.plugins.clipboard.isCustomDataTypesSupported &&
										...
										(c.dataValue = CKEDITOR.pasteFilters.image(c.dataValue, a, g)),
				...
				exec: function (a) {
					for (
						var h =
							...
							c = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(',')),
								...
								if (b.isReadOnly()) {
									...
									(k = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT)),
										('img' == b.getName() && b.data('cke-realelement')) ||
											!e(a, b) ||
											(h.test(b.getName()) ? b.remove(1) : (b.removeAttributes(c), a.fire('removeFormatCleanup', b))),
										(b = k);
						f.moveToBookmark(l);
					}
					a.forceNextSelectionCheck();
	...
	CKEDITOR.plugins.add('scayt', {
		...
		parseConfig: function (a) {
			...
			'string' !== typeof a.config.scayt_srcUrl &&
				(a.config.scayt_srcUrl = 'https://svc.webspellchecker.net/spellcheck31/wscbundle/wscbundle.js');
				...
				if (d)
					for (d = 0; d < c.length; d++) {
						...
						d < a.config.scayt_maxSuggestions
							? (a.addMenuItem(l, { label: c[d], command: l, group: 'scayt_suggest', order: d + 1 }),
								(b[l] = CKEDITOR.TRISTATE_OFF))
							: (a.addMenuItem(l, { label: c[d], command: l, group: 'scayt_moresuggest', order: d + 1 }),
					...
					for (d = 0; d < c.length; d++)
						(l = 'grayt_suggest_' + CKEDITOR.plugins.scayt.suggestions[d].replace(' ', '_')),
							a.addCommand(l, this.createCommand(CKEDITOR.plugins.scayt.suggestions[d], f, g)),
							a.addMenuItem(l, { label: c[d], command: l, group: 'grayt_suggest', order: d + 1 }),
							(b[l] = CKEDITOR.TRISTATE_OFF);
			else
			...
			l
				...
				: m &&
					...
					d.getGraytNodeRuleAttributeName
						? ((k = c.getAttribute(d.getGraytNodeRuleAttributeName())), d.getProblemDescriptionText(e, k, g))
						: d.getProblemDescriptionText(e, g),
					(n = d.getProblemDescriptionText(e, k, g)),
					b.grayt_problemdescription &&
						n &&
						((n = n.replace(/([.!?])\s/g, '$1\x3cbr\x3e')), (b.grayt_problemdescription.label = n)),
					d.fire('getGrammarSuggestionsList', { lang: g, phrase: e, rule: k }),
					(e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, l)));
			if (l && 'off' == a.config.scayt_contextCommands) return e;
			for (var h in b)
				(l && -1 == CKEDITOR.tools.indexOf(f, h.replace('scayt_', '')) && 'all' != a.config.scayt_contextCommands) ||
					(m &&
						'grayt_problemdescription' !== h &&
						-1 == CKEDITOR.tools.indexOf(f, h.replace('grayt_', '')) &&
						'all' != a.config.scayt_contextCommands) ||
					((e[h] = 'undefined' != typeof b[h].state ? b[h].state : CKEDITOR.TRISTATE_OFF),
					'function' !== typeof b[h].verification || b[h].verification(a) || delete e[h],
			...
			init: function (c) {
					...
					if ((a = a.data.styles)) {
						for (var b, f, d, g = 0, n = a.length; g < n; g++)
							...
							(c.blockless && b.element in CKEDITOR.dtd.$block) ||
								...
								((f = b.name), (b = new CKEDITOR.style(b)), c.filter.customConfig && !c.filter.check(b))) ||
								((b._name = f),
								(b._.enterMode = l.enterMode),
								(b._.type = d = b.assignedTo || b.type),
								(b._.weight = g + 1e3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3)),
								(e[f] = b),
								k.push(b),
								m.push(b));
						k.sort(function (a, b) {
				...
				c.ui.addRichCombo('Styles', {
					...
					onOpen: function () {
						...
						b[CKEDITOR.STYLE_BLOCK] || this.hideGroup(h['panelTitle' + String(CKEDITOR.STYLE_BLOCK)]);
	...
	(function () {
		function q(d, f) {
			...
			for (var a = d.getRanges(), k = 0; k < a.length; k++) {
				var g = a[k];
				if (g.collapsed) (g = g.getCommonAncestor().getAscendant({ td: 1, th: 1 }, !0)) && b(g) && e.push(g);
				else {
			...
			for (l = k; l <= g; l++)
				for (n = 0; n < a.length; n++)
					(h = a[n]),
						...
						h.$ &&
							(1 == h.$.colSpan ? h.remove() : --h.$.colSpan, (n += h.$.rowSpan - 1), e.$.cells.length || m.push(e));
			k =
				a[0].length - 1 > g
					...
					d.addMenuItems({
						tablecell: {
							...
							getItems: function () {
								...
								d.filter.check(h) &&
									(a.tablecell_properties = 0 < b.length ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
								return a;
							},
						},
	...
	(function () {
				...
				for (g = l; g <= p; g++)
					(d = new CKEDITOR.dom.element(e[c][g])),
						d.$ &&
							...
							(h.push(d), CKEDITOR.dom.element.setMarker(f, d, 'selected_cell', !0));
		...
		function L(a) {
			...
			if (b && (A(a), b.isInTable() && b.isFake))
				...
				else if (!c[0]._getTableElement({ table: 1 }).hasAttribute('data-cke-tableselection-ignored')) {
					1 === c.length &&
		...
		function w(a) {
			...
			function d(a, b, d, e) {
				if ('mousedown' === a.name && (CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT || !e))
					return !0;
				if ((b = a.name === (CKEDITOR.env.gecko ? 'mousedown' : 'mouseup') && !c(a.data.getTarget())))
			...
			if (a.data.getTarget().getName && ('mouseup' === a.name || !D(a.data.getTarget()))) {
				...
				(h && h.hasAttribute('data-cke-tableselection-ignored')) ||
					...
					!m.active &&
						...
						h &&
						((m = { active: !0 }), CKEDITOR.document.on('mouseup', w, null, { editor: e })),
					(f || h) && K(e, f || h, a),
					'mouseup' === a.name &&
						(CKEDITOR.tools.getMouseButton(a) === CKEDITOR.MOUSE_BUTTON_LEFT &&
		...
		function M(a) {
			...
			(b && b.hasAttribute('data-cke-tableselection-ignored')) ||
				((a = a.data.getTarget().getAscendant({ td: 1, th: 1 }, !0)), !a || a.hasClass('cke_table-faked-selection'));
		}
		function N(a, b) {
			function c(a) {
				a.cancel();
		...
		function E(a) {
			var b = a.editor || a.sender.editor,
				c = b.getSelection();
			c.isInTable() &&
				(c.getRanges()[0]._getTableElement({ table: 1 }).hasAttribute('data-cke-tableselection-ignored') ||
					N(b, 'cut' === a.name));
		}
		function q(a) {
			this._reset();
		...
		q.prototype.insertRow = function (a, b, c) {
			...
			for (
				var d = this.cells.first.$.cellIndex, e = this.cells.last.$.cellIndex, g = c ? [] : this.cells.all, k, h = 0;
				h < a;
				h++
			)
				(k = F(c ? this.cells.all : g, b)),
					(k = CKEDITOR.tools.array.filter(k.find('td, th').toArray(), function (a) {
		...
		q.prototype.insertColumn = function (a) {
			...
			for (var c = this.cells, d = c.all, e = r(c.first), g = r(c.last), c = 0; c < a; c++)
				...
				(function (a, b, d, c) {
					...
					if ((b = !c))
						(b = a[0])
							? ((b = b.clone()),
								b.enlarge(CKEDITOR.ENLARGE_ELEMENT),
								(b = (b = b.getEnclosedNode()) && b.is && b.is(CKEDITOR.dtd.$tableContent)))
							: (b = void 0),
							(b = !b);
					return b ? !1 : !0;
				})(e, g, h, k) &&
					...
					h
						? (a.stop(),
							k ? (f.insertRow(1, 1 === k, !0), e.selectElement(f.rows.first)) : (f.emptyCells(), t(d, f.cells.all)),
							(a = f.getTableMap()),
					...
					for (h = new CKEDITOR.dom.element(g.$.rows[a.rows.first.$.rowIndex + l]), p = 0; p < c[l].length; p++)
						if (
							...
							if (d && d.getParent()) f.replace(d);
								...
								(d = 0 !== p ? new CKEDITOR.dom.element(c[l][p - 1]) : null) && h.equals(d.getParent())
									? f.insertAfter(d)
									: 0 < e
										? h.$.cells[e]
							...
							if (g[f] && !a.readOnly && (k = a.getSelection()) && k.isInTable() && k.isFake) {
								...
								if (36 < f && 41 > f) n[0].moveToElementEditablePosition(m ? q : r, !m), k.selectRanges([n[0]]);
									...
									13 === f && a.plugins.enterkey
										? (a.fire('lockSnapshot'),
											13 === l ? a.execCommand('enter') : a.execCommand('shiftEnter'),
											a.fire('unlockSnapshot'),
											a.fire('saveSnapshot'))
	...
	(function () {
		...
		function ba(a, b) {
			function c(a, e) {
				var c = b.upcast.split(','),
					d,
					f;
				for (f = 0; f < c.length; f++) if (((d = c[f]), d === a.name)) return b.upcasts[d].call(this, a, e);
				return !1;
			}
			function d(b, e, c) {
				...
				if (b) {
					...
					if (a && a.initOnlyNew) c = this.initOnAll();
						...
						for (e = l.count(); d < e; d++) {
							...
							g &&
								b.contains(f) &&
								(f.addClass('cke_widget_new'), c.push(this.initOn(f.getFirst(h.isDomWidgetElement))));
						}
					}
							...
							if ('data-cke-widget-id' in c) {
								if ((c = a.instances[c['data-cke-widget-id']]))
									(e = b.getFirst(h.isParserWidgetElement)),
										f.push({ wrapper: b, element: e, widget: c, editables: {} }),
										'1' != e.attributes['data-cke-widget-keep-attr'] && delete e.attributes['data-widget'];
							} else if ('data-cke-widget-editable' in c)
								return 0 < f.length && (f[f.length - 1].editables[c['data-cke-widget-editable']] = b), !1;
						},
						CKEDITOR.NODE_ELEMENT,
						!0,
					);
				...
				function (a) {
					if (a.data.downcastingSessionId)
						for (var b = c[a.data.downcastingSessionId], f, g, l, k, h, m; (f = b.shift()); ) {
							...
							a.data.widgetsCopy &&
								g.getClipboardHtml &&
								((k = CKEDITOR.htmlParser.fragment.fromHtml(g.getClipboardHtml())), (k = k.children[0]));
							for (m in f.editables)
								(h = f.editables[m]), delete h.attributes.contenteditable, h.setHtml(g.editables[m].getData());
							k || (k = l);
		...
		function R(a) {
			...
			b.on('dataReady', function () {
				if (d)
					for (var c = b.editable().find('.cke_widget_wrapper'), f, g, l = 0, k = c.count(); l < k; ++l)
						(f = c.getItem(l)),
				...
				commit: function () {
					...
					for (f && (g = a.focused) && x(a, g); (g = d.pop()); )
						b.splice(CKEDITOR.tools.indexOf(b, g), 1),
							g.isInited() && ((l = g.editor.checkDirty()), g.setSelected(!1), !l && g.editor.resetDirty());
					f &&
						e &&
		...
		function G(a, b) {
			...
			u.hasCopyBin(a) ||
				...
				c ||
					((d = CKEDITOR.env.webkit && CKEDITOR.plugins.widgetselection.isWholeContentSelected(a.editable())),
			...
			if (this.wrapper) {
				...
				if (a && 'string' != typeof a) {
					...
					b ||
						...
						b.setAttributes({ src: CKEDITOR.tools.transparentImageData, class: 'cke_reset cke_widget_partial_mask' }),
		...
		function ka(a) {
			if (a.draggable) {
				...
				if (!a.inline && (d.on('mousedown', pa, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version))
					...
					if (this.checkApplicable(h, a))
						for (var k = 0, n = this.group.length; k < n; k++) {
							...
							for (var m = 0; m < c.length; m++)
								c[m] !== this && c[m].checkActive(h, a) && (a.widgets.focused.removeStyle(c[m]), (b = !0));
						}
					return b;
				},
				checkActive: function (a, b) {
					...
					init: function () {
						...
						k.on('update', function (b) {
							...
							if (d.wrapper && d.wrapper.getParent()) {
								a.fire('lockSnapshot');
								b = 'on' + f(k.status);
								if ('abort' === k.status || 'function' !== typeof d[b] || !1 !== d[b](k))
									(e = 'cke_upload_' + k.status),
										d.wrapper && e != g && (g && d.wrapper.removeClass(g), d.wrapper.addClass(e), (g = e)),
										('error' != k.status && 'abort' != k.status) || a.widgets.del(d);
								a.fire('unlockSnapshot');
							} else
	...
	(function () {
				...
				a.match(/<div>(<br>|)<\/div>/) &&
					(a =
						...
						a.replace(/(<div>(<br>|)<\/div>)+/g, function (a) {
							return g(a.split('\x3c/div\x3e\x3cdiv\x3e').length + 1);
						}) +
						'\x3c/p\x3e'),
		...
		function k() {
			function b(a) {
				var b = {},
					d;
				for (d in CKEDITOR.dtd) '$' != d.charAt(0) && (a || ('div' != d && 'span' != d)) && (b[d] = 1);
				return b;
			}
			function a(e) {
				return e.attributes.id && e.attributes.id.match(/^docs\-internal\-guid\-/)
					? !0
			...
			function g(a) {
				var d = a.attributes.style && CKEDITOR.tools.parseCssText(a.attributes.style);
				if (a.attributes.id && a.attributes.id.match(/^docs\-internal\-guid\-/)) return (a.name = 'span');
				d &&
					('italic' == d['font-style'] && 'underline' == d['text-decoration']
						? ((a.name = 'em'),
							a.wrapWith(new CKEDITOR.htmlParser.element('u')),
							400 < d['font-weight'] && a.wrapWith(new CKEDITOR.htmlParser.element('strong')))
						: 'underline' == d['text-decoration']
							? ((a.name = 'u'), 400 < d['font-weight'] && a.wrapWith(new CKEDITOR.htmlParser.element('strong')))
							: 'italic' == d['font-style'] &&
								((a.name = 'em'), 400 < d['font-weight'] && a.wrapWith(new CKEDITOR.htmlParser.element('strong'))));
			}
			function d() {
				var a = new CKEDITOR.filter();
				a.allow({ $1: { elements: b(), attributes: !0, styles: !1, classes: !1 } });
				return a;
			}
			function f() {
				var c = d();
			...
			return {
				get: function (a) {
					return 'plain-text' == a
						? c.plainText || (c.plainText = new CKEDITOR.filter('br'))
						: 'semantic-content' == a
							? c.semanticContent || (c.semanticContent = d())
							: 'webkit-default-filter' == a
								? c.webkitDefaultFilter || (c.webkitDefaultFilter = f())
								: a
			...
			init: function (b) {
				...
				b.config.forcePasteAsPlainText
					...
					: b.config.pasteFilter
						...
						: !CKEDITOR.env.webkit || 'pasteFilter' in b.config || (a = 'webkit-default-filter');
				b.pasteFilter = g.get(a);
				b.on(
					'paste',
					function (a) {
						a.data.dataTransfer || (a.data.dataTransfer = new CKEDITOR.plugins.clipboard.dataTransfer());
						if (!a.data.dataValue) {
							var f = a.data.dataTransfer,
								c = f.getData('text/html');
							if (c) (a.data.dataValue = c), (a.data.type = 'html');
							else if ((c = f.getData('text/plain')))
								(a.data.dataValue = b.editable().transformPlainTextToHtml(c)), (a.data.type = 'text');
						}
					},
					null,
					null,
				...
				b.on(
					...
					function (a) {
						...
						a.dataTransfer.getTransferType(b);
						e = 'html' == f || 'html' == a.preSniffing ? 'html' : m(c);
						'htmlifiedtext' == e && (c = n(b.config, c));
						if ('text' == f && 'html' == e) {
							var k = g.get('plain-text'),
								c = CKEDITOR.htmlParser.fragment.fromHtml(c),
								l = new CKEDITOR.htmlParser.basicWriter();
							k.applyTo(c, !0, !1, b.activeEnterMode);
							c.writeHtml(l);
							c = l.getHtml();
						}
						a.startsWithEOL && (c = '\x3cbr data-cke-eol\x3d"1"\x3e' + c);
						a.endsWithEOL && (c += '\x3cbr data-cke-eol\x3d"1"\x3e');
						'auto' == f && (f = 'html' == e || 'html' == h ? 'html' : 'text');
						a.type = f;
						a.dataValue = c;
		...
		onLoad: function () {
			function e(c) {
				...
				b.state != CKEDITOR.TRISTATE_DISABLED &&
					(this.createPanel(c),
					b.on ? b.panel.hide() : b.panel.showBlock(this._.id, this.document.getById(this._.id), 4));
			}
						...
						if (!b.panel) {
							...
							d.onHide = function (d) {
								...
								!a.modes && g
									...
									: a.setState(a.modes && a.modes[c.mode] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
								b.on = 0;
	...
	CKEDITOR.config.colorButton_colors =
		'000,202020,404040,606060,808080,9f9f9f,bfbfbf,dfdfdf,fff,330000,660000,990000,cc0000,ff0000,ff3333,ff6666,ff9999,ffcccc,331a00,663300,994d00,cc6600,ff8000,ff9933,ffb366,ffcc99,ffe6cc,333300,666600,999900,cccc00,ffff00,ffff33,ffff66,ffff99,ffffcc,1a3300,336600,4d9900,66cc00,80ff00,99ff33,b3ff66,ccff99,e6ffcc,003300,006600,009900,00cc00,00ff00,33ff33,66ff66,99ff99,ccffcc,00331a,006633,00994d,00cc66,00ff80,33ff99,66ffb3,99ffcc,ccffe6,003333,006666,009999,00cccc,00ffff,33ffff,66ffff,99ffff,ccffff,001a33,003366,004d99,0066cc,0080ff,3399ff,66b3ff,99ccff,cce6ff,000033,000066,000099,0000cc,0000ff,3333ff,6666ff,9999ff,ccccff,1a0033,330066,4d0099,6600cc,8000ff,9933ff,b366ff,cc99ff,e6ccff,330033,660066,990099,cc00cc,ff00ff,ff33ff,ff66ff,ff99ff,ffccff,33001a,660033,99004d,cc0066,ff0080,ff3399,ff66b3,ff99cc,ffcce6';
	...
	CKEDITOR.config.plugins =
		'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,resize,elementspath,enterkey,entities,popup,filetools,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,xml,ajax,pastetools,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,tableselection,undo,lineutils,widgetselection,widget,notificationaggregator,uploadwidget,uploadimage,pasteFromGoogleDoc,panelbutton,colorbutton';
	...
	(function () {
		...
		if (CKEDITOR.env.hidpi)
			setIcons(
				'about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,bgcolor,1032,,textcolor,1056,',
				'icons_hidpi.png',
			);
		else
			setIcons(
				'about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,bgcolor,1032,auto,textcolor,1056,auto',
				'icons.png',
			);
	})();
